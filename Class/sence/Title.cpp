...
void Title::Initialize() {
	...
	logo_omote_->texture = LWP::Resource::LoadTextureLongPath("resources/system/texture/honoka_logo_hontai_.png");
	...
	logo_ura->texture = LWP::Resource::LoadTextureLongPath("resources/system/texture/honoka_logo_ura.png");
